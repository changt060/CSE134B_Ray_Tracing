...
(3) Getting "a bytes-like object is required, not 'str'" error

(4) https://raviucsdgroup.s3.amazonaws.com/hw2/6ebc1be81a5e35e183f5c95810914d6e/20220204002351/index.html

(5) Transform.cpp, readfile.cpp, and display.cpp are inside hw2-windows folder whereas light.frag.glsl is inside hw2-windows/shaders folder

(6) Windows

(7) The UCSD Online code grader portion keeps throwing error "a bytes-like object is required, not 'str'"